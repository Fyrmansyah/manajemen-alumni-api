...
@section('title', 'Buat Lowongan Baru - BKK SMKN 1 Surabaya')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0">Buat Lowongan Baru</h1>
                    <p class="text-muted mb-0">Posting lowongan kerja untuk kandidat terbaik</p>
                </div>
                <div>
            ...
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-plus-circle me-2"></i>Form Lowongan Kerja
                    </h6>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form id="jobForm" method="POST" action="{{ route('company.jobs.createJob') }}">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title" required 
                                   placeholder="Contoh: Software Developer, Marketing Manager"
                                   value="{{ old('title') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="5" required
                                      placeholder="Jelaskan tanggung jawab, tugas, dan deskripsi pekerjaan secara detail...">{{ old('description') }}</textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="requirements" name="requirements" rows="4" required
                                      placeholder="Tuliskan kualifikasi, pengalaman, dan persyaratan yang dibutuhkan...">{{ old('requirements') }}</textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="location" name="location" required
                                       placeholder="Contoh: Surabaya, Jakarta, Remote"
                                       value="{{ old('location') }}">
                                <div class="invalid-feedback"></div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="job_type" name="job_type" required>
                                    ...
                                    @foreach($jobTypes ?? \App\Models\Job::JOB_TYPES as $key => $value)
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="includeSalary">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="salary_min" name="salary_min" 
                                                   placeholder="0" min="0" value="{{ old('salary_min') }}">
                                        </div>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="salary_max" name="salary_max" 
                                                   placeholder="0" min="0" value="{{ old('salary_max') }}">
                                        </div>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="application_deadline" name="application_deadline" 
                                       required min="{{ date('Y-m-d', strtotime('+1 day')) }}" value="{{ old('application_deadline') }}">
                                <div class="invalid-feedback"></div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="positions_available" name="positions_available" 
                                       required min="1" value="{{ old('positions_available', 1) }}">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary" id="submitBtn">
                                <i class="fas fa-save me-2"></i>Buat Lowongan
                            </button>
                        </div>
                    </form>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    jobForm.addEventListener('submit', function(e) {
        ...
        // If salary section is hidden, remove salary values
        ...
        // The controller will handle validation and redirect
    });
    ...
    @if($errors->any())
        @foreach($errors->getMessages() as $field => $messages)
            ...
            if ({{ $field }}Input) {
                ...
                const feedback = {{ $field }}Input.parentNode.querySelector('.invalid-feedback');
                if (feedback) {
